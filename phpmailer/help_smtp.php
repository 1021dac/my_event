...
<head>
    ...
    <meta name="description" content="Ronaldo TC ">
    <meta name="author" content="Ansonika">
    <title>Ronaldo TC </title>
</head>
...
try {
    ...
    $mail->setFrom('info@Ronaldo TC .com', 'Message from Ronaldo TC ');                    // Email Address and Name FROM
    $mail->addAddress('info@Ronaldo TC .com', 'Jhon Doe');                            // Email Address and Name TO - Name is optional
    $mail->addReplyTo('noreply@Ronaldo TC .com', 'Message from Ronaldo TC ');              // Email Address and Name NOREPLY
    $mail->isHTML(true);                                                       
    $mail->Subject = 'Message from Ronaldo TC ';                                      // Email Subject   
